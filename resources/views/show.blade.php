    ...
    <div class="buttons-containers flex items-center justify-between mt-6">
        <div class="flex items-center space-x-2 ml-4">
            <div class="relative">
                ...
                <div
                    class="hidden absolute z-10 w-104 text-left font-semi-bold bg-white shadow-dialog rounded-xl mt-2 shadow-lg">
                    ...
                    <form action="" class="space-y-4 px-4 py-4">
                        ...
                        <div class="space-y-2">
                            <div>
                                <label class="inline-flex items-center">
                                    <input  type="radio" checked
                                        class="bg-gray-200 text-green-500 border-none" name="radio-direct" value="1">
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input  type="radio"
                                        class="bg-gray-200 text-gray-500 border-none" name="radio-direct" value="1">
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input  type="radio"
                                        class="bg-gray-200 text-yellow-500 border-none" name="radio-direct" value="1">
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input  type="radio"
                                        class="bg-gray-200 text-blue-500 border-none" name="radio-direct" value="1">
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input  type="radio"
                                        class="bg-gray-200 text-red-500 border-none" name="radio-direct" value="1">
                                    <span class="ml-2">Closed</span>
                                </label>
                            </div>
                        </div>
                        <textarea class="w-full text-sm bg-gray-100 rounded-xl placeholder-gray-900 border-none px-4 py-2" name="update_comment" id="update_comment" cols="30" rows="4" placeholder="Add an Update Comment (Optional)"></textarea>
