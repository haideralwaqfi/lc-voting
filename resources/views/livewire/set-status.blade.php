...
>
    ...
    <div x-cloak x-show.origin.top.left="isOpen" x-transition @click.away="isOpen = false"
            ...
            <div class="space-y-2">
                <div>
                    <label class="inline-flex items-center">
                        <input type="radio" wire:model="status" class="bg-gray-200 text-gray-600 border-none" name="status"
                            value="1" checked>
                ...
                <div>
                    <label class="inline-flex items-center">
                        <input type="radio" wire:model="status" class="bg-gray-200 text-purple border-none" name="status"
                            value="2">
                ...
                <div>
                    <label class="inline-flex items-center">
                        <input type="radio" wire:model="status" class="bg-gray-200 text-yellow border-none" name="status"
                            value="3">
                ...
                <div>
                    <label class="inline-flex items-center">
                        <input type="radio" wire:model="status" class="bg-gray-200 text-green border-none" name="status"
                            value="4">
                ...
                <div>
                    <label class="inline-flex items-center">
                        <input type="radio" wire:model="status" class="bg-gray-200 text-red border-none" name="status"
                            value="5">
