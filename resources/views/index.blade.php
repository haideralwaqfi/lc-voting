...
<div class="container flex space-y-6 my-6">
    <div class="idea-container bg-white flex rounded-xl hover:shadow-md transition duration-150 ease-in">
        ...
        <div class="flex flex-none px-2 py-6">
            <div>
                <a href="">
        ...
        <div class="mx-4 py-6">
            ...
            <div class="flex items-center justify-between mt-6">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <button class="relative bg-gray-100 hover:bg-gray-200 border border-gray-300 rounded-full h-7 px-4 transition duration-150 ease-in">
